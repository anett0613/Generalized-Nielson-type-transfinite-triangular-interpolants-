...
namespace cagd
{
    ...
    protected:
        ...
        ColumnMatrix<DCoordinate3>  _data; // p_0, p_1, p_2, p_3, or _data[0] = p_i, _data[1] = p_i + lambda_{i,j} * t_{i,j}, _data[2] = p_j + lambda_{j,i} * t_{j,i}, _data[3] = p_j
    ...
    public:
        ...
        // generate image/arc
        virtual GenericCurve3* GenerateImage(GLuint max_order_of_derivatives,
